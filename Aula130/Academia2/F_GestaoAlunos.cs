    ...
    public partial class F_GestaoAlunos : Form
    {
        ...
        private void F_GestaoAlunos_Load(object sender, EventArgs e)
        {
            vqueryDGV = @"
                ...
                FROM
                    tb_alunos
            ";
            dgv_alunos.DataSource = Banco.dql(vqueryDGV);  //Banco.dql
            ...
            cb_turmas.DataSource = Banco.dql(vqueryTurmas); //Banco.dql
        ...
        private void btn_salvarEdicoes_Click(object sender, EventArgs e)
        {
            ...
            if (turmaAtual != turma)
            {
                ...
                Banco.dml(queryAtualizarAluno);  //banco.dml
        ...
        private void btn_excluirAluno_Click(object sender, EventArgs e)
        {
            ...
            {
                if (File.Exists(pb_carteirinha.ImageLocation))
                {
                    File.Delete(pb_carteirinha.ImageLocation);
                }
                string vqueryExcluirAluno = String.Format(@"
                    ...
                    WHERE
                        N_IDALUNO={0}
                ",idSelecionado);
                Banco.dml(vqueryExcluirAluno);//banco.dml
        ...
        private void dgv_alunos_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                ...
                string vqueryCampos = String.Format(@"
                    ...
                    WHERE N_IDALUNO={0}
                ",idSelecionado);
                DataTable dt = Banco.dql(vqueryCampos);//banco.dql
                ...
                pb_carteirinha.ImageLocation = dt.Rows[0].Field<string>("T_FOTO");
                //turmaAtual = cb_turmas.Text;
            }
        }
    }
