...
namespace Academia2
{
    public partial class F_GestaoProfessores : Form
    {
        ...
        private void F_GestaoProfessores_Load(object sender, EventArgs e)
        {
            ...
            dgv_professores.DataSource = Banco.consulta(vquery);
            dgv_professores.Columns[0].Width = 60;
            dgv_professores.Columns[1].Width = 170;
            dgv_professores.Columns[3].Width = 100;
        }
        ...
        {
            DialogResult res = MessageBox.Show("Confirma Exclusão?", "Exclusão?",MessageBoxButtons.YesNo);
