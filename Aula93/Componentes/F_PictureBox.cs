...
namespace Componentes
{
    public partial class F_PictureBox : Form
    {
        ...
        {
            pictureBox1.Image = Properties.Resources.artificial_intelligence_benefits_risk;
        }

        private void btn_logo2_Click(object sender, EventArgs e)
        {
            pictureBox1.Image = Properties.Resources.MbOtj8;
        }

        private void btn_rabisco_Click(object sender, EventArgs e)
        {
            pictureBox1.Image = Properties.Resources._20200615_110208;
        }
    }
}
